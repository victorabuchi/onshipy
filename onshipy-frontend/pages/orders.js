    ...
    <Layout title="Orders">
      ...
      <div style={{ fontFamily: P.font, fontSize: P.fontSize, letterSpacing: P.letterSpacing, color: P.text, display: 'flex', height: 'calc(100vh - 56px)' }}>
        <div style={{ flex: 1, overflowY: 'auto', background: P.bg, minWidth: 0 }}>
          ...
          {/* ── ANALYTICS BAR: white, full width, flush to top — no margin ── */}
                  ...
                  <div style={{ padding: '24px 0', animation: 'fadeIn .3s ease' }}>
                    <div style={{ display: 'flex', gap: 40, alignItems: 'center', flexWrap: 'wrap' }}>
                      <div style={{ flex: 1, minWidth: 280 }}>
                        ...
                        <span style={{ color: '#2b6cb0', cursor: 'pointer', fontSize: P.fontSize }}>Learn more about abandoned checkouts</span>
                      </div>
