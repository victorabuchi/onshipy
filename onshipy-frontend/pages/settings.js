    ...
    <>
      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .st-nav { width: 260px; flex-shrink: 0; background: #f6f6f7; border-right: 1px solid rgba(227,227,227,1); overflow-y: auto; position: sticky; top: 56px; height: calc(100vh - 56px); align-self: flex-start; }
