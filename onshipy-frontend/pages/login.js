    ...
    <>
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
        ...
        .card { background:#fff; border-radius:14px; box-shadow:0 8px 48px rgba(0,0,0,0.5); width:100%; max-width:420px; padding:36px 40px 32px; }

        .card-title { font-size:22px; font-weight:800; color:${text}; letter-spacing:-0.5px; margin-bottom:4px; }
        .card-sub { font-size:13px; color:${sub}; margin-bottom:24px; }
        ...
        .label { font-size:12px; font-weight:600; color:${text}; }
        .forgot { font-size:12px; color:${green}; text-decoration:none; font-weight:500; }
        .forgot:hover { text-decoration:underline; }

        .inp-wrap { position:relative; }
        .inp { width:100%; height:42px; border:1px solid ${bd}; border-radius:8px; padding:0 12px; font-size:14px; color:${text}; background:#fff; outline:none; font-family:inherit; transition:border-color .15s; }
        ...
        .submit-btn { width:100%; height:44px; background:#1a1a1a; color:#fff; border:none; border-radius:9px; font-size:15px; font-weight:700; cursor:pointer; margin-top:6px; transition:opacity .15s; display:flex; align-items:center; justify-content:center; gap:8px; font-family:inherit; }
        ...
        .bottom-link { text-align:center; margin-top:20px; font-size:13px; color:${sub}; }
      ...
      <div className="page">
        ...
        <div className="card">
          ...
          <p className="card-sub">Continue to Onshipy</p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="field">
              ...
              <div className="inp-wrap">
                <input className="inp" type={showPw ? 'text' : 'password'} placeholder="Enter your password" value={form.password} onChange={e => setForm({...form, password:e.target.value})} style={{ paddingRight:36 }} required />
          ...
          <p className="bottom-link">
            New to Onshipy?{' '}
            <Link href="/register" style={{ color:green, fontWeight:600, textDecoration:'none' }}>Create free account</Link>
          </p>
        </div>
